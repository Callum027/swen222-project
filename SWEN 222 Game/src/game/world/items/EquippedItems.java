...
/**
 * The Items that the Player has currently equipped. Implementation involving equipping items is done in this class
 * @author Nick Tran
 *
 */
public class EquippedItems {
	 ...
	 * @param head the head armour to equip
	 */
	 ...
	 * @param body the armour to equip
	 */
	 ...
	 * @param mainHand the weapon to equip
	 */
	 ...
	 * @param offHand the weapon to equip
	 */
